...
public class RequestPacienteMembresiaDto {
	...
	public Boolean validarMarca(RequestPacienteMembresiaDto request) throws Exception {
	...
	public boolean validarlineaNegocio(RequestPacienteMembresiaDto request) {
